const DownloadStore = ({ playstore = '', applestore = '' }) => {
    return (
      <div className="container p-2 border border-white border-rounded">
        <div className="row">
          <div className="col d-flex align-items-center pl-4">
            {applestore && (
                <i className={`fa fa-${applestore} mr-2`} style={{ fontSize: '2.25rem', lineHeight: '1.5' }}></i>
            )}
            {playstore === 'Google Play' && (
                <i className="fa fa-android mr-2" style={{ fontSize: '2.25rem', lineHeight: '1.5' }}></i>
            )}
            <div>
