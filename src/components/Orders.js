  ...
  return (
    <div className="row card bg-white">
      <div className="card-body">
        ...
        <div className="Orders-setting-panel-wrap pt-2">
          <ul
            className="nav nav-tabs nav-tabs-s3 mb-2"
            id="myTab"
            role="tablist"
          >
          ...
          <div className="tab-content mt-4" id="myTabContent">
            ...
            >
              <div className="activity-tab-wrap p-4"></div>
            </div>
            <div
              className="tab-pane fade"
              id="closed"
            ...
            >
              <div className="activity-tab-wrap"></div>
            </div>
          </div>
        </div>
      </div>
