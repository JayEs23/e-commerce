...
const WishlistButton = ({
  ...
  return (
    <>
      <button
        className={`icon-btn wishlist-button ${
          isInWishlist ? "active bg-primary" : ""
        }`}
        onClick={isAuthenticated ? handleWishlistToggle : handleLoginModalOpen}
      ...
      <Toast
        ...
        autohide
      >
        <Toast.Body className="text-primary text-nowrap text-success">
          Added to wishlist successfully.
          <em className="ni ni-check-circle-cut 2x"></em>
        </Toast.Body>
      </Toast>
