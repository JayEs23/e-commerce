...
const Sidebar = ({ userProfile }) => {
  ...
  const navLinks = [
    ...
    {
      href: "/account/ratings-reviews",
      label: "Ratings and Reviews",
      icon: "ni ni-star-full",
    },
  ];
  ...
  return (
    <>
      ...
      <p className="mx-4 text-black">Welcome to your Inshopper account.</p>
      <hr />
      ...
      <div className="sidebar sidebar-user-mobile">
        ...
        <ul className="user-nav">
          <li
            key="../../account/address"
            className={router.pathname === "/account/address" ? "active" : ""}
          >
            <a href="../../account/address">Address box</a>
          </li>
        </ul>
      </div>
    </>
