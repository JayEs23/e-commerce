            ...
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-lg-10 mx-auto align-items-center">
                  <center><h1 className="justify-content-center">
                    <span
                        ...
                        <div className="card-body">
                                    ...
                                    <section className="bg-gray card mb-4">
                                        ...
                                        <div className="row m-2">
                                            <div className="col-6">
                                                ...
                                                <label><b>{userProfile?.address}</b></label>
                                            </div>
                                            <div className="col-6">
                                                <p>Billing Address</p>
                                                <label><b>{userProfile?.address}</b></label>
                            ...
                            <div className="row">
                                <div className="col-lg-6 mx-auto">
                                    <button className="btn btn-primary" onClick={()=> handleEdit(true)}>Add New Address</button>
                                </div>
