            ...
            <section className="explore-section pt-lg-4">
              <div className="container">
                ...
                <div className="filter-container row g-gs">
                  <div className="col-md-3 d-none d-lg-block h-400 bg-gray">

                  </div>
                  <div className="col-md-8">
                    <h4 className="text-danger text-center">Please login to view profile details</h4>
                    <center><a href="../../login" className="btn btn-primary btn-lg float-center mt-4">Connect Wallet</a></center>
                ...
                <div className="author-hero-content-wrap d-flex flex-wrap justify-content-between ms-3 flex-grow-1">
                    <div className="author-hero-content me-3">
                        ...
                        <div className="d-flex align-items-center">
                            <input type="text" className="copy-input text-white" value={truncateKey(userData.publicKey)} id="copy-input" readonly />
                            <div className="tooltip-s1">
                                <button data-clipboard-target="#copy-input" className="copy-text text-white ms-2" type="button"><span className="tooltip-s1-text tooltip-text">Copy</span><em className="ni ni-copy"></em></button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="sidebar sidebar-user-mobile">
                                ...
                                <div className="sidebar-widget">
                                    <ul className="user-nav">
                                        <li className="active">
                                            <a href="#"><em className="ni ni-edit me-2"></em>Edit Profile</a>
                                        </li>
                                        <li>
                                            <a href="#"><em className="ni ni-money me-2"></em>My Assets</a>
                                        </li>
