...
const AccountDashboard = ({profile, handleEdit}) => {
      ...
      <div className="card-body">
        {userProfile ?(
          <><h3 className="card-title m-2 mb-4 ">My Account</h3>
            <section className="bg-gray card mb-4">
              <div className="row bg-gray m-2 pt-4">
                  ...
                  <div className="col-2"><button className="btn" onClick={() => handleEdit(true)}><em className="ni ni-edit"></em> Edit</button></div>
                </div>
            ...
            <section className="bg-gray card my-4">
              <div className="row bg-gray m-2 pt-4">
                  <div className="col-10"><p className="title">Personal Information</p></div>
                  <div className="col-2"><button className="btn" type="button" onClick={() => handleEdit(true)}><em className="ni ni-edit" ></em> Edit</button></div>
                </div>
                <div className="row m-2">
                  <div className="col-6">
                    <p>Country</p>
                    <label><b>{userProfile?.country}</b></label>
                  </div>
                  <div className="col-6">
                    <p>State</p>
                    <label><b>{userProfile?.state} State</b></label>
                  </div>
                </div>
                <div className="row m-2 mt-3">
                  <div className="col-6">
                  ...
                  <div className="col-6">
                    <p>Postal Code</p>
                    <label><b>{userProfile?.postal_code}</b></label>
                  </div>
                </div>
            </section></>
        ):(
          <div class="alert alert-danger d-flex mb-4" role="alert">
              ...
              <p class="fs-14">Please Login to View your Profile <LoginModal /></p>
          </div>
