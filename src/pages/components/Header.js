        ...
        <div className="container">
          <div className="header-wrap">
            ...
            <div className="header-search-form border-2 mx-4 d-none d-lg-flex d-flex justify-content-end">
              <form action="/search" onSubmit={handleSearchSubmit} className="d-flex">
                <input
                  type="search"
                  name="search"
            ...
            <nav className="header-menu menu nav mobile-menu">
              ...
              {isAuthenticated ?(
                ...
                <li className="d-none d-lg-inline-block dropdown">
                    ...
                    <ul className="dropdown-menu card-generic card-generic-s3 dropdown-menu-end mt-2">
                        <li><h6 className="dropdown-header">Hello {userProfile?.first_name || ''} !</h6></li>
                        <li>
                            <a className="dropdown-item card-generic-item" href="../user/profile"><em className="ni ni-user me-2"></em> Profile</a>
                        </li>
                        <li>
                        ...
                        <li><hr className="dropdown-divider" /></li>
                        <li>
                            <a className="dropdown-item card-generic-item" onClick={logout} ><em className="ni ni-power me-2"></em> Disconnect</a>
                        </li>
                    </ul>
                </li>
              </ul>
              ...
              <ul className="menu-list ms-lg-auto">
                <li class="menu-item has-sub">
                  <a href="#" class="menu-link menu-toggle text-nowrap">My Account</a>
                    <div class="menu-sub">
                        <ul class="menu-list">
                ...
                <li class="menu-item has-sub">
                  <a href="#" class="btn menu-link menu-toggle" data-bs-toggle="modal" data-bs-target="#moreModal">More</a>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div className="row card m-2">
              <a href="" className="btn btn-primary text-nowrap">Start a live chat</a>
              <div className="col-lg-10 mt-2 ">
                <div className="header-item">
                  <p className="my-2">ABOUT INSHOPPER</p>
                  <ul className="list-item list-item-s1 text-dark">
                    <li>
                      <a className="text-dark" href="https://www.inshopper.io"><b>Inshopper Services</b></a>
                    </li>
                    <li>
                      <a className="text-dark" href="#"><b>FAQs</b></a>
                    </li>
                    <li>
                      <a className="text-dark" href="#"><b>Privacy Policy</b></a>
                    </li>
                  </ul>
                </div>
                <div className="header-item">
                  ...
                  <ul className="list-item list-item-s1 text-dark">
                    <li>
                      <a className="text-dark" href="https://www.inshopper.io"><b>Push Notification</b></a>
                    </li>
                    <li>
                      <p className="text-dark"><b>Country</b> <span class="badge text-primary justify-content-end">Nigeria</span></p>
                    </li>
                    <li>
                      <p className="text-dark"><b>Language</b> <span class="badge text-primary justify-content-end">English</span></p>
                    </li>
                  </ul>
                </div>
