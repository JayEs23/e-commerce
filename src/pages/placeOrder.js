...
const CartPage = () => {
  ...
  const [address, setAddress] = useState(
    "27 dedamola Crescent, Olodi Apapa, Amosun, Oyo, Lagos State, Nigeria"
  );
        ...
        <div className="content font-sm p-4">
          <div className="row mt-4 p-4">
                ...
                <div className="row bg-gray h-200 mb-4">
                  ...
                  <div className="col-md-3 m-2 h-100">
                    <div className="form-check mb-2 ">
                      <input
                        className="form-check-input justify-content-between"
                        style={{ marginTop: "40px", bottom: "50" }}
                        type="checkbox"
                        id="masterCard"
                        // checked=""
                      />
                      <label
                        className="form-check-label form-check-label-s1 w-100 gap-4x"
                        style={{
                          backgroundColor: "#70308d",
                          borderRadius: "8px",
                        }}
                        htmlFor="masterCard"
                      ></label>
                ...
                <div className="row bg-gray h-300 mb-4">
                  ...
                  <div className="row my-2 mt-2">
                    <div className="col-md-10 mx-2">
                      <div className="form-check mb-2 ">
                        <input
                          className="form-check-input mt-16"
                          type="checkbox"
                          id="delivery1"
                          // checked=""
                        />
                        <label
                          className="form-check-label form-check-label-s1 w-100"
                          htmlFor="delivery1"
                        >
                          Free Delivery
                        </label>
                    ...
                    <div className="col-md-10 mx-4">
                      <div className="form-check mb-2 ">
                        <input
                          className="form-check-input justify-content-between"
                          style={{ marginTop: "20px", bottom: "50" }}
                          type="checkbox"
                          id="delivery2"
                          // checked=""
                        />
            ...
            <div className="col-lg-3">
              <CartSummary cartData={cart?.items} isConfirm={false} />
              <ContactSellerModal />
            </div>
          </div>
        </div>
